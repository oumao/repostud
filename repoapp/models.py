...
class User(db.Model, UserMixin):
    ...
    students = db.relationship('Student', backref='user', lazy='dynamic', ondelete='CASCADE')
    lecturers = db.relationship('Lecturer', backref='user', lazy='dynamic', ondelete='CASCADE')

    def __repr__(self):
        return f"<User: {self.first_name} {self.last_name} {self.gender}>"
...
class Student(db.Model):
    ...
    submitted_assignments = db.relationship('SubmittedAssignment',
                                            backref='student',
                                            lazy='dynamic', ondelete='CASCADE')
...
class Course(db.Model):
    ...
    assignments = db.relationship('Assignment', backref='course', lazy=True, ondelete='CASCADE')
    assignment_submitted = db.relationship('SubmittedAssignment', backref='course', lazy='dynamic', ondelete='CASCADE')
